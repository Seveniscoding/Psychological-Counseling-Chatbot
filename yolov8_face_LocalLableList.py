...
import emotion_buffer # save emotion to buffer
import json  #for save buffer
import os 
...
emotion_model_path ="checkpoints/run_2025-04-24_18-30/17.pt"  # Using latest trained one
...
emotion_labels = ["Contempt", "Happy", "Neutral", "Sad", "Anger", "Disgust", "Surprise", "Fear"] #local computer os sequence
...
while True:
    ...
    for result in results:
        ...
        for box in boxes:
            ...
            emotion_buffer.save_emotion_to_json(emotion_label) #save emotion to buffer !!! 
